...
func CRMManifest() Manifest {
	...
	roles := []Role{
		...
		role("technician", "技术人员", "处理本人被指派的售前任务", "presale.read", "presale.contact_phone.read", "presale.progress", "presale.worklog", "presale.complete"),
		role("implementation_engineer", "实施工程师", "处理本人被指派的售前任务", "presale.read", "presale.contact_phone.read", "presale.progress", "presale.worklog", "presale.complete"),
