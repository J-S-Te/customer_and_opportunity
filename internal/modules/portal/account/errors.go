...
var (
	...
	ErrAuthorizationUnavailable = apperror.New(http.StatusServiceUnavailable, "PORTAL_AUTHORIZATION_UNAVAILABLE", "authorization service is temporarily unavailable")
