...
const (
	...
	DefaultActorID   = "oidc-sub-demo-seed"
...
func People() map[string]Person {
	return map[string]Person{
		...
		"刘明":  {Sub: "oidc-sub-liu-ming", Name: "刘明", OrgID: "org-demo-east1", OrgName: "华东一区"},
		"李婷芳": {Sub: "oidc-sub-li-tingfang", Name: "李婷芳", OrgID: "org-demo-south1", OrgName: "华南一区"},
		"王建国": {Sub: "oidc-sub-wang-jianguo", Name: "王建国", OrgID: "org-demo-east1", OrgName: "华东一区"},
		"赵晓燕": {Sub: "oidc-sub-zhao-xiaoyan", Name: "赵晓燕", OrgID: "org-demo-south1", OrgName: "华南一区"},
	}
}
	...
	return []customerSeed{
		{
			...
			CustomerType: "业主", Industry: "金融", Region: "华南", OwnerKey: "陈浩然",
			Contacts: []contactSeed{
		...
		},
		{
			...
			CustomerType: "三方", Industry: "能源", Region: "华南", OwnerKey: "刘明",
			Contacts: []contactSeed{
		...
		},
		{
			...
			CustomerType: "政府", Industry: "医疗", Region: "华东", OwnerKey: "陈浩然",
			Contacts: []contactSeed{
		...
		},
		{
			...
			CustomerType: "业主", Industry: "金融", Region: "华北", OwnerKey: "陈浩然",
			Contacts: []contactSeed{
	...
	return []opportunitySeed{
		{
			...
			OwnerKey:       "陈浩然", Stage: "需求沟通",
			Members: []memberSeed{
				{UserKey: "王建国", Role: "TECHNICAL_SUPPORT"},
				{UserKey: "赵晓燕", Role: "BUSINESS_SUPPORT"},
				{UserKey: "刘明", Role: "SALES_SUPPORT"},
			},
			Followups: []followupSeed{
		...
		},
		{
			...
			OwnerKey:       "陈浩然", Stage: "报价",
			Members: []memberSeed{
				{UserKey: "王建国", Role: "TECHNICAL_SUPPORT"},
				{UserKey: "赵晓燕", Role: "TECHNICAL_SUPPORT"},
			},
			Followups: []followupSeed{
		...
		},
		{
			...
			OwnerKey:       "李婷芳", Stage: "投标",
			Members: []memberSeed{
				{UserKey: "赵晓燕", Role: "TECHNICAL_SUPPORT"},
				{UserKey: "王建国", Role: "TECHNICAL_SUPPORT"},
				{UserKey: "陈浩然", Role: "SALES_SUPPORT"},
			},
			Followups: []followupSeed{
		...
		},
		{
			...
			SystemCount:        0, OwnerKey: "刘明", Stage: "已签约",
		...
		},
		{
			...
			SystemCount:        1, OwnerKey: "李婷芳", Stage: "失败",
		...
		},
		{
			...
			SystemCount:        2, OwnerKey: "陈浩然", Stage: "已签约",
		...
		},
		{
			...
			SystemCount:        1, OwnerKey: "赵晓燕", Stage: "失败",
